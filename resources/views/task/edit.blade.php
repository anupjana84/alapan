                  ...
                  <h2 class="card-title text-center">Create Task</h2>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          value="{{ old('heading',$task->heading) }}"
                              placeholder=" Heading ">
                          @error('heading')
                              <span class="invalid-feedback" role="alert">
                                  <strong>{{ $message }}</strong>
                   ...
                   <div class="form-group">
                    ...
                    <textarea class="form-control" id="desciption"
                     name="description" value="{{ old('description',$task->description) }}" rows="3">{{$task->description}}</textarea>
                      @error('description')
                          <span class="invalid-feedback" role="alert">
                              <strong>{{ $message }}</strong>
                          </span>
                  ...
                  @enderror
                   ...
                   <div class="col-md-6">
                     <div class="form-group">
                      ...
                      <select type="text" class="form-control 
                       @error('status') is-invalid @enderror" name="status" value="{{old('status') }}" 
                         >
